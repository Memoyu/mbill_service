    ...
    public static class SwaggerSetup
    {
        public static IServiceCollection AddSwagger(this IServiceCollection services)
        {
            services.AddSwaggerGen(opt =>
            {
                ...
                opt.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "mbill_service.xml"));
                opt.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "mbill_service.Service.xml"));
                ...
                opt.AddSecurityDefinition("oauth2", new OpenApiSecurityScheme
                {
                    ...
                    Flows = new OpenApiOAuthFlows
                    {
                        AuthorizationCode = new OpenApiOAuthFlow
                        {
                            ...
                            {
                                { "mbill_service", "Access read/write mbill_service" }
                            }
                        },
