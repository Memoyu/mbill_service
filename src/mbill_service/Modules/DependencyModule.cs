using Autofac;
using mbill_service.Core.Interface.IDependency;
using System;
using System.Linq;
...
namespace mbill_service.Modules
{
    public class DependencyModule : Autofac.Module
    {
        ...
        {
            Assembly[] currentAssemblies = AppDomain.CurrentDomain.GetAssemblies().Where(r => r.FullName.Contains("mbill_service")).ToArray();
